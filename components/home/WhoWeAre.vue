  ...
  <section class="why-choose-bg mt-14 md:mt-20 lg:mt-32">
    <div class="custom-container">
      <div class="pt-md-5 pt-sm-4 pt-0 xl:pb-8 lg:pb-3 pb-0">
        ...
        <div class="why-choose-box bg-white py-6 sm:py-14 mb-4 px-5 sm:px-10 rounded-3xl w-full lg:w-[700px] xl:w-[800px]" data-aos="zoom-in-up" data-aos-delay="600" data-aos-duration="800">
